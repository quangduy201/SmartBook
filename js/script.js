    ...
    const category = [
        {id:1, name:"Giáo dục", quantity:0, listcategory: [
            {id:1, name:"Sách giáo khoa", quantity:0, books:[
                ...
                {id:1, name:"nhl",cat:null,price:"200.000"+" VND",quantity:10,image:"assets/images/product/Sach/KinhTe/ChungKhoan/product-tst.jpg"},
                {id:1, name:"nhl",cat:null,price:"200.000"+" VND",quantity:10,image:"assets/images/product/Sach/KinhTe/ChungKhoan/product-tst.jpg"},
                {id:1, name:"long",cat:null,price:"200.000"+" VND",quantity:10,image:"assets/images/product/Sach/KinhTe/ChungKhoan/product-tst.jpg"},
                {id:1, name:"long",cat:null,price:"200.000"+" VND",quantity:10,image:"assets/images/product/Sach/KinhTe/ChungKhoan/product-tst.jpg"},
                {id:1, name:"long",cat:null,price:"200.000"+" VND",quantity:10,image:"assets/images/product/Sach/KinhTe/ChungKhoan/product-tst.jpg"},
                {id:1, name:"long",cat:null,price:"200.000"+" VND",quantity:10,image:"assets/images/product/Sach/KinhTe/ChungKhoan/product-tst.jpg"},
                {id:1, name:"long",cat:null,price:"200.000"+" VND",quantity:10,image:"assets/images/product/Sach/KinhTe/ChungKhoan/product-tst.jpg"},
            ...
            {id:2, name:"Sách tham khảo", quantity:0, books:[
                {id:1, name:"thamkhao",cat:null,price:"200.000"+" VND",quantity:10,image:"assets/images/product/Sach/KinhTe/ChungKhoan/product-tst.jpg"},
    
            ]},
            {id:3, name:"Từ điển", quantity:0, books:[
                {id:1, name:"tu dien",cat:null,price:"200.000"+" VND",quantity:10,image:"assets/images/product/Sach/KinhTe/ChungKhoan/product-tst.jpg"},
    
            ]},
        ]},
        {id:2, name:"Văn học", quantity:0, listcategory: [
            {id:1, name:"Truyện ngắn", quantity:0, books:[
                {id:1, name:"Chết vì chứng khoán",cat:null,price:"200.000"+" VND",quantity:10,image:"assets/images/product/Sach/KinhTe/ChungKhoan/product-tst.jpg"},
...
const bestseller = [
    {id:1, name:"Chết vì chứng khoán",cat:"Sách Kinh Tế",price:"200.000"+" VND",quantity:"0",image:"assets/images/product/Sach/KinhTe/ChungKhoan/product-tst.jpg"},
